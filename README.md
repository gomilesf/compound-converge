...
protocol gates stay byte-identical across each platform's vendored copies
(all generated by `bun run sync` from the canonical
`skills-src/cvg-multi-session/SKILL.md`), the findings
