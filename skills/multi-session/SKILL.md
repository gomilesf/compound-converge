---
name: multi-session
description: Orchestrate monitored Codex thread workflows with specialist handoff, callback transport, heartbeat waiting, blocker classification, and fresh-reviewer exit gates. Use when the user asks to coordinate multiple Codex sessions, run an orchestrator workflow, supervise planning or implementation, or manage worker/reviewer loops.
