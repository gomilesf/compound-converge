...
description: "Handle code-review blocker findings in the worker session. Validate feedback, repair implementation-owned issues, or stop for plan and contract gaps."
---
